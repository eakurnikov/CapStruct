...
// TODO: возможно глобальнейшая бажина тут. Вектор скорости всегда торчит из начала координат. В уравнении могут использоваться координаты этого вектора, как вторая точка вместе с координатой, а это значит, что будут дико кривые траектории
