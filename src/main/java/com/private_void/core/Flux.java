...
public class Flux {
    ...
    public Flux(final Point3D fluxCoordinate, final Vector3D fluxSpeed, int fluxLength, int particlesAmountPerLayer, float layerDistance) {
    ...
    public void Flux(final Point3D fluxCoordinate, final Vector3D fluxAxis, int particlesAmountTotal, float divergentAngleDegrees)
    {
        rand = new Random();
