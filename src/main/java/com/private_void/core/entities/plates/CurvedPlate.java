...
public class CurvedPlate extends Plate {
    private final RotatedCylinderFactory capillarFactory;
    ...
    public CurvedPlate(final RotatedCylinderFactory capillarFactory, final CartesianPoint center, double capillarsDensity,
