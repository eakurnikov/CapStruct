...
public class Distribution {
    ...
    private void convertChanneledToFile() {
    ...
    private void convertPiercedToFile() {
    ...
    private void convertChanneledStripeXToFile() {
    ...
    private void convertPiercedStripeXToFile() {
    ...
    private void convertChanneledStripeYToFile() {
    ...
    private void convertPiercedStripeYToFile() {
