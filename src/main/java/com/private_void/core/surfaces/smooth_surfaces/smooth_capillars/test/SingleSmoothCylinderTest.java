...
public class SingleSmoothCylinderTest extends SingleSmoothCapillarTest {

    public SingleSmoothCylinderTest(final CartesianPoint front, double radius, double length, double roughnessSize,
